 ...
 */
ConnectionPool.prototype.add = function(user) {
 ...
 * @return void
 */
ConnectionPool.prototype.join = function(swarm, user) {
 ...
 * @return boolean
 */
ConnectionPool.prototype.leave = function(swarm, user_id) {
 ...
 * @return int
 */
ConnectionPool.prototype.getSwarmSize = function(domain, swarm) {
 ...
 * @return  Set
 */
ConnectionPool.prototype.in = function(domain, swarm) {
 ...
 * @return void
 */
ConnectionPool.prototype.delete = function(user_id) {
 ...
 * @return Socket\User
 */
ConnectionPool.prototype.get = function(user_id) {
